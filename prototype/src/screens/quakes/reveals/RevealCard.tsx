...
// [Take-away callout]
//
// Class-claim sidebar is rendered once at the top of the reveal section,
// not per-card — see QuakeClaim for that summary block.
    ...
    <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
      <div className="p-5 sm:p-6 border-b border-slate-100">
        <div className="flex items-baseline gap-3">
          <div className="grid place-items-center w-8 h-8 rounded-lg bg-rose-600 text-white font-display font-bold text-sm shrink-0">
            Q{index}
          </div>
